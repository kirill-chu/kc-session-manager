...
class SeatManager:
    ...
    def __init__(self):
        ...
        self.seat_proxy: ProxyInterface | None = None
        self.current_idle_hint: bool = False
        self.idle_hint_listeners: list = []
        self.session_removed_listeners: list = []
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.error(f"SeatManager initialization error: {e}", exc_info=e)
            return False
        ...
        if "IdleHint" in changed:
            ...
            if new_idle != self.current_idle_hint:
                ...
                for listener in self.idle_hint_listeners:
                    task = asyncio.create_task(listener(new_idle))
    ...
    async def get_active_sessions_count(self) -> int:
        ...
        try:
            ...
            logger.error(f"Error getting active sessions: {e}", exc_info=e)
            return 0
