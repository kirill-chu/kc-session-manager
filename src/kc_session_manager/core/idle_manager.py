...
class IdleManager:
    ...
    async def initialize(self):
        ...
        try:
            ...
            logger.error(f"Initialization error IdleManager: {e}", exc_info=e)
            return False
    ...
    async def _get_current_session_path(self, manager_interface):
        ...
        try:
            ...
            logger.error(f"Getting current session path error: {e}", exc_info=e)
            return None
    ...
    async def _execute_locker(self, event_type: str) -> None:
        ...
        try:
            ...
            logger.error(f"Executing lock session command error: {e}", exc_info=e)
    ...
    async def set_idle(self, idle: bool):
        ...
        try:
            ...
            logger.error(f"Setting idle error: {e}", exc_info=e)
            return False
